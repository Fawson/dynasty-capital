interface PageHeaderProps {
  title: string
  subtitle?: string
  icon?: 'teams' | 'matchups' | 'draft' | 'trade' | 'trades' | 'analysis' | 'value' | 'whatif' | 'nfl' | 'about' | 'overview' | 'resources' | 'team' | 'snapshot'
}
  ...
  return (
    <div className="relative mb-6">
      ...
      <div className="flex items-start gap-4 pl-4">
        {/* Icon */}
        {icon && (
          <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500/20 to-amber-600/10 border border-amber-500/30 flex items-center justify-center text-amber-500">
            {icons[icon]}
          </div>
        )}
